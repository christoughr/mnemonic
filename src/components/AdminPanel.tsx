  ...
  return (
    <div className="space-y-6 sm:space-y-8">
      <div className="text-center">
        ...
        <p className="text-gray-600 text-sm sm:text-base">Configure and ingest data from your integrations</p>
      </div>
      ...
      <div className="bg-white rounded-lg shadow-sm border p-4 sm:p-6">
        <div className="flex items-center mb-3 sm:mb-4">
          ...
          <h3 className="text-base sm:text-lg font-semibold text-gray-900">Slack Integration</h3>
        </div>
        ...
        <div className="space-y-3 sm:space-y-4">
          ...
          <div>
            ...
            <select
              ...
              className="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent mb-2 text-sm sm:text-base"
            >
          ...
          <button
            ...
            className="w-full px-4 py-2 bg-green-600 text-white rounded-md hover:bg-green-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors text-sm sm:text-base"
          >
      ...
      <div className="bg-white rounded-lg shadow-sm border p-4 sm:p-6">
        <div className="flex items-center mb-3 sm:mb-4">
          <span className="text-xl sm:text-2xl mr-2 sm:mr-3">📝</span>
          <h3 className="text-base sm:text-lg font-semibold text-gray-900">Notion Integration</h3>
        </div>
        ...
        <div className="space-y-3 sm:space-y-4">
          ...
          <button
            ...
            className="w-full px-4 py-2 bg-purple-600 text-white rounded-md hover:bg-purple-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors text-sm sm:text-base"
          >
      ...
      <div className="bg-gray-50 rounded-lg p-4 sm:p-6">
        <h4 className="font-semibold text-gray-900 mb-2 sm:mb-3 text-sm sm:text-base">Setup Instructions</h4>
