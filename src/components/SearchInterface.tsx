    ...
    <div className="space-y-6">
      ...
      <form onSubmit={handleSearch} className="space-y-4">
        <div className="relative">
          ...
          <button
            ...
            className="absolute right-2 top-2 bottom-2 px-6 bg-blue-600 text-white rounded-md font-medium hover:bg-blue-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
          >
        ...
        <div className="space-y-6">
          ...
          {result.bestExpert.author !== 'No expert found' && (
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
              <h3 className="text-lg font-semibold text-blue-900 mb-2">Best Expert</h3>
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-blue-800 font-medium">{result.bestExpert.author}</p>
      ...
      {!isLoading && !result && !error && (
        <div className="text-center py-12">
          ...
          <h3 className="text-xl font-medium text-gray-900 mb-2">Start searching your team&apos;s knowledge</h3>
